...
import statement.*;
	...
	public class TestAdd {
		...
		public static void main(String[] args) {
			...
			ASTNode leftright = new ASTNode(new Addition(), left, null, null);
			ASTNode right = new ASTNode(new Say(), root, null, null);
			
			//ASTNode leftrightleft = new ASTNode(new StringE(new StringValue("aaaaaaa")), left, null, null);
			//ASTNode leftrightright = new ASTNode(new StringE(new StringValue("nn")), left, null, null);
			ASTNode leftrightleft = new ASTNode(new Constant(new IntValue(302)), left, null, null);
			ASTNode leftrightright = new ASTNode(new Constant(new IntValue(10)), left, null, null);
